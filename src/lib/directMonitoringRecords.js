...
export async function syncDirectMonitoringRecords() {
...
export async function loadDirectMonitoringRecords() {
  const localRecords = await syncDirectMonitoringRecords();
...
export async function saveDirectMonitoringRecord(record) {
...
export async function updateDirectMonitoringRecord(record) {
